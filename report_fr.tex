...
\newcommand{\And}[2]{#1\hspace{2pt}\textnormal{\textbf{et}}\hspace{2.5pt}#2}
\newcommand{\Not}[1]{\textnormal{\textbf{non}}(#1)}
\newcommand{\Neither}[2]{\And{\Not{#1}}{\Not{#2}}}
...
\Begin({MoteurInférence($B$, $S$)}){
  ...
  \Repeat{\textit{ajouté}}{
    ...
    \While{$B' \neq$ \textit{base\_vide}}{
      \tcp{Si la prémisse n'est pas vide et la conclusion n'appartient pas à $S'$...}
